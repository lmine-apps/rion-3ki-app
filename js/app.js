...
function mockApi(action, body) {
  ...
  const plans = {
    'VIP':        { label: 'VIPコース', total: 990000, note: 'みこのセッション3回／中尾真巳の算命学鑑定1回（受講料に含む）／リトリート 12月5〜6日（参加費無料）／卒業式 2027年1月24日／講義動画の視聴期限1年', split: [495000, 495000] },
    'スタンダード': { label: 'スタンダードコース', total: 770000, note: 'みこのセッション2回／中尾真巳の算命学鑑定は別途鑑定料／卒業式 2027年1月24日／講義動画の視聴期限1年', split: [385000, 385000] },
    '3.5期生':     { label: '3.5期生', total: 385000, note: '中尾真巳の算命学鑑定は別途鑑定料／卒業式への参加はありません／講義動画の視聴期限1年', split: [192500, 192500] }
  };
